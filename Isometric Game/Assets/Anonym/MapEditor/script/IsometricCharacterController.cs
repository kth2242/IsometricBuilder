...
namespace Anonym.Isometric
{
	...
	public class IsometricCharacterController : MonoBehaviour {
		...
		[SerializeField]
		bool bOnMoving = false;
		[SerializeField]
		bool bDashing = false;
		[HideInInspector]
		bool bOnJumpingBoost {get{return fJumpingPowerDurationInst > 0;}}
		[SerializeField]
		float fJumpingPower = 0.1f;
		[SerializeField]
		float fJumpingPowerDuration = 0.2f;
		[SerializeField]
		float fJumpingPowerDurationInst = 0;

		[SerializeField]
		Vector3 vDestination;
		[SerializeField]
		string FloorLayerMask = "Default";
		[SerializeField]
		float fMaxDropHeight = 100f;
	
		[SerializeField]
		bool bFreeJumpMode = true;
		[SerializeField]
		float fMaxDashInputInterval = 0.33f;
		float fLastInputTime = 0;

		[SerializeField]
		bool bUseCCSize = false;
		[SerializeField]
